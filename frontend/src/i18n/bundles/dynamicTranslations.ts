...
import type { Language } from "./coreTranslations"
...
const ENTRIES: readonly Entry[] = [
  ...
  ["Strong Wind Advisory", "तेज़ हवा परामर्श", "জোরালো বাতাসের পরামর্শ"],
  ...
  // ── Saved locations (Alerts & Travel tab) ──────────────────────────
  ["Darjeeling", "दार्जिलिंग", "দার্জিলিং"],
  ["Digha Beach", "दीघा बीच", "দিঘা সৈকত"],
  ["Digha", "दीघा", "দিঘা"],
  ["Sundarbans", "सुंदरबन", "সুন্দরবন"],
  ["Siliguri", "सिलीगुड़ी", "শিলিগুড়ি"],
  ["Kolkata", "कोलकाता", "কলকাতা"],
  ["Howrah", "हावड़ा", "হাওড়া"],
  ["Salt Lake", "सॉल्ट लेक", "সল্টলেক"],
  ["New Town", "न्यू टाउन", "নিউ টাউন"],
  ["Alipore", "अलीपुर", "আলিপুর"],
  ["Dum Dum", "दम दम", "দমদম"],

  // ── Weather condition overrides / extra alerts ─────────────────────
  ["Foggy Rain", "कोहरे वाली वर्षा", "কুয়াশাচ্ছন্ন বৃষ্টি"],
  ["Rough Seas", "अशांत समुद्र", "উত্তাল সমুদ্র"],
  ...
  ["Event Planner", "आयोजन प्लानर", "অনুষ্ঠান প্ল্যানার"],
  ["Weekend Outdoor Weather Outlook", "सप्ताहांत बाहरी मौसम परिदृश्य", "উইকএন্ডের বাইরের আবহাওয়ার পূর্বাভাস"],
  ["Durga Puja 2026", "दुर्गा पूजा 2026", "দুর্গা পুজো ২০২৬"],
  ["Durga Puja", "दुर्गा पूजा", "দুর্গা পুজো"],
  ["Diwali", "दिवाली", "দীপাবলি"],
  ["Kali Puja", "काली पूजा", "কালী পুজো"],
  ["Monsoon", "मानसून", "বর্ষা"],
  ["Post-Monsoon", "मानसून के बाद", "বর্ষা-পরবর্তী"],
  ["Post-monsoon", "मानसून के बाद", "বর্ষা-পরবর্তী"],
  ["Pre-Monsoon", "मानसून-पूर्व", "প্রাক্-বর্ষা"],
  ["Pre-monsoon", "मानसून-पूर्व", "প্রাক্-বর্ষা"],
  ["Winter", "सर्दी", "শীতকাল"],
  ["Summer", "गर्मी", "গ্রীষ্মকাল"],
  ["High Rain", "भारी वर्षा", "ভারী বৃষ্টি"],
  ["Moderate Rain", "मध्यम वर्षा", "মাঝারি বৃষ্টি"],
  ["Low Rain", "कम वर्षा", "কম বৃষ্টি"],
  ["No Rain", "कोई वर्षा नहीं", "কোনো বৃষ্টি নেই"],
  ["Foggy", "कोहरा", "কুয়াশাচ্ছন্ন"],
  [
    "High rain chance this weekend — plan indoor alternatives or flexible timing.",
    "इस सप्ताहांत वर्षा की अधिक संभावना — इनडोर विकल्प या लचीला समय रखें।",
    "এই উইকএন্ডে বৃষ্টির প্রবল সম্ভাবনা — ঘরের ভেতরের বিকল্প বা নমনীয় সময় রাখুন।",
  ],
  [
    "Some rain possible — keep an eye on the forecast closer to the date.",
    "कुछ वर्षा संभव — तारीख के करीब पूर्वानुमान पर नज़र रखें।",
    "কিছু বৃষ্টির সম্ভাবনা — তারিখের কাছাকাছি পূর্বাভাসের দিকে নজর রাখুন।",
  ],
  [
    "Favorable weather expected — good window for outdoor plans.",
    "अनुकूल मौसम की संभावना — बाहरी योजनाओं के लिए अच्छा समय।",
    "অনুকূল আবহাওয়ার সম্ভাবনা — বাইরের পরিকল্পনার জন্য দারুণ সুযোগ।",
  ],
  [
  ...
  ["Sept", "सितंबर", "সেপ্টেম্বর"],
  ["Sep", "सितंबर", "সেপ্টেম্বর"],
  ["Aug", "अगस्त", "আগস্ট"],
  ["Oct", "अक्तूबर", "অক্টোবর"],
  ["Nov", "नवंबर", "নভেম্বর"],
  ["Dec", "दिसंबर", "ডিসেম্বর"],
  ["Jan", "जनवरी", "জানুয়ারি"],
  ["Feb", "फ़रवरी", "ফেব্রুয়ারি"],
  ["Mar", "मार्च", "মার্চ"],
  ["Apr", "अप्रैल", "এপ্রিল"],
  ["May", "मई", "মে"],
  ["Jun", "जून", "জুন"],
...
const PATTERNS: ReadonlyArray<{
  ...
  // Date and range patterns
  { match: /^(\d+)\s+([A-Za-z]+)\s*[–-]\s*(\d+)\s+([A-Za-z]+)$/, hi: "$1 @2–$3 @4", bn: "$1 @2–$3 @4" },
  { match: /^(\d+)\s*[–-]\s*(\d+)\s+([A-Za-z]+)$/, hi: "$1–$2 @3", bn: "$1–$2 @3" },
  { match: /^(\d+)\s+([A-Za-z]+)\s*[–-]\s*(\d+)$/, hi: "$1–$3 @2", bn: "$1–$3 @2" },
  { match: /^(\d+)\s+([A-Za-z]+)\s+(\d{4})$/, hi: "$1 @2 $3", bn: "$1 @2 $3" },
  { match: /^(\d+)\s+([A-Za-z]+)$/, hi: "$1 @2", bn: "$1 @2" },
  { match: /^([A-Za-z]+)\s+(\d+)\s*[–-]\s*(\d+)$/, hi: "$2–$3 @1", bn: "$2–$3 @1" },
  { match: /^([A-Za-z]+)\s+(\d+)$/, hi: "$2 @1", bn: "$2 @1" },
  // Alerts & Travel dynamic patterns
  { match: /^Rain chance is (\d+)%\. Allow extra travel time and avoid underpasses\.$/, hi: "वर्षा की संभावना $1% है। यात्रा में अतिरिक्त समय रखें और अंडरपास से बचें।", bn: "বৃষ্টির সম্ভাবনা $1%। যাত্রায় বাড়তি সময় রাখুন এবং আন্ডারপাস এড়িয়ে চলুন।" },
  { match: /^Wind gusts near (\d+) km\/h expected\. Secure loose outdoor items\.$/, hi: "लगभग $1 किमी/घंटा के हवा के झोंके संभावित। बाहर रखी खुली चीज़ों को सुरक्षित करें।", bn: "প্রায় $1 কিমি/ঘন্টা দমকা বাতাসের সম্ভাবনা। বাইরের আলগা জিনিসপত্র নিরাপদ রাখুন।" },
  { match: /^High temperature \((\d+)°C\)$/, hi: "अधिक तापमान ($1°C)", bn: "বেশি তাপমাত্রা ($1°C)" },
  { match: /^Cooler temperatures \((\d+)°C\)$/, hi: "ठंडा तापमान ($1°C)", bn: "ঠান্ডা তাপমাত্রা ($1°C)" },
  { match: /^Strong wind \((\d+) km\/h\)$/, hi: "तेज़ हवा ($1 किमी/घंटा)", bn: "জোরালো বাতাস ($1 কিমি/ঘন্টা)" },
  ...
  { match: /^India AQI (\d+)(?: \((.+)\))?$/, hi: "भारत AQI $1 (@2)", bn: "ভারত AQI $1 (@2)" },
