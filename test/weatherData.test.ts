...
import { DEMO_WEATHER_DATA, fetchWeatherDashboard, resolveWeatherIcon } from '../src/weatherData'

const LOCATION = { latitude: 22.5726, longitude: 88.3639, locality: 'Kolkata', region: 'West Bengal', country: 'India', source: 'device' as const }
...
function minimalLivePayload(overrides: Record<string, unknown> = {}) {
  return {
    ...
    current: {
      ...
      humidity: 60, windSpeed: 10, windDirection: 'SW', windGust: 15, visibility: 8, pressure: 1010, dewPoint: 18,
      heatIndex: 30, high: 32, low: 24, hydrationAdvice: 'Stay hydrated — drink water regularly.', isDay: true,
    },
    ...
    uv: { index: 3, scaleMax: 11, scaleLabels: ['Low'], label: 'Low', recommendation: 'None', peakHours: 'noon', burnTime: '~60 min', advice: 'None' },
    astronomy: { sunrise: '5:20 am', sunset: '5:50 pm', solarNoon: '11:35 am', moonPhase: 'Waning Crescent', goldenHour: '5:20 pm', moonrise: '—' },
    comfort: { index: 80, label: 'Comfortable', icon: '🙂', advice: 'Nice.', factors: [] },
    running: { badge: 'FITNESS', start: '6 am', end: '8 am', summary: 'Good conditions' },
    rainfall: { chance: 5, today: 0, unit: 'mm', periodLabel: 'Today', monthLabel: 'September' },
    commute: { status: 'NORMAL', location: 'Kolkata', items: [] },
    swimming: { badge: 'FAVORABLE', venue: 'Kolkata Swimming Pool', distance: '12km', depth: 2.1, depthUnit: 'm', waterTemperature: 26, peakTime: '11 am', advice: 'Good.' },
    ...
    event: { sectionLabel: 'Event Planner', icon: '🌤️', title: 'Weekend Outdoor Weather Outlook', dateRange: '6-7 Sep', daysAway: 1, expectedSeason: 'Monsoon', expectedTemperature: 30, rainLabel: 'Low Rain', rainChance: 10, advice: 'Favorable.' },
    ...overrides,
  }
}
