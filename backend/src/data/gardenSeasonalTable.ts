...
const GARDEN_SEASONAL: Record<IndiaSeason, GardenSeasonalInfo> = {
  Monsoon: { title: 'Aman rice transplanting season', note: '🐟 Hilsa season active!' },
  'Post-Monsoon': { title: 'Aman rice harvesting season', note: '🌾 Harvest season for local paddy fields' },
  Winter: { title: 'Boro rice & winter vegetable season', note: '🥦 Good season for leafy greens and winter vegetables' },
  Summer: { title: 'Pre-monsoon planting preparation', note: '🌱 Prepare soil ahead of monsoon sowing' },
}
