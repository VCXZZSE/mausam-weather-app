/**
 * Widget A — Typographic minimal, matches reference design.
 * Android 2×2 home screen widget: 155dp × 155dp canvas.
 * Mixed-weight text, primary data bright, connective words muted.
 */
...
const W = 288  // rendered px (matches Android 2×2 ~155dp at 1.85x)
const R = 20   // corner radius — Android widget convention
